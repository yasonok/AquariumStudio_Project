...
| Group ID | 專案 | 任務 | 模型 | 狀態 |
|----------|------|------|------|------|
| -5192967461 | 桌上型水族網站製作 | 開發 Aquarium Studio 電商網站 | MiniMax | 上線 |
| -5144687626 | 每日新聞與星座運勢 | 每天抓取台灣新聞與星座，早上 8 點發送 | MiniMax | 待命 |
| -5215480233 | SEO 網站架設 | 架設 SEO 網站，每天發布一篇優化文章 | MiniMax | 進行中 |
| -5242091244 | NanoBanana | Gemini 圖片生成 | Gemini 2.0 Flash | 獨立 Workspace + API |
