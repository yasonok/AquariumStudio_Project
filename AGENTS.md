...
**文件位置**：`AVAILABLE_TOOLS.md`

所有 Agent 啟動時會自動載入此清單，得知可用工具。

---

## 🎯 已配置 SubAgent

| 名稱 | Group ID | 專案 | 任務 | Workspace | 狀態 |
|------|----------|------|------|-----------|------|
| AQUABOT | -5192967461 | 桌上型水族網站製作 | 開發 Aquarium Studio 電商網站 | 獨立 | 上線 |
| Daily_news | -5144687626 | 每日新聞與星座運勢 | 每天抓取台灣新聞與星座，早上 8 點發送 | 共享 | 待命 |
| Seo_agent | -5215480233 | SEO 網站架設 | 架設 SEO 網站，每天發布一篇優化文章 | 獨立 | 進行中 |
